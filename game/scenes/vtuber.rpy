label scene_vtuber:
    ...
    vtuber "Hiya everyone, it's FireAnt-chan!!"
    ...
    menu:
        ...
        "Show feet pls" if v_feet:
            ...
            "Frank B4nkM3y3r was banned from the chat."
            "The End."
            return
        "I am about to die" if v_die:
            ...
            vtuber "Poor B4nkM3y3r, what illness do you have?"
